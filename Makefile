...
boost:
        ...
        docker exec  taic-reg-api bash -c "chown -R www-data:www-data /var/www/html/storage /var/www/html/public"
        docker exec  taic-reg-api bash -c "chown -R www-data:www-data /var/www/html/storage /var/www/html/bootstrap/cache"
