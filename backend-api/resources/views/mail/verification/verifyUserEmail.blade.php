...
<p style="padding:4px 2px; margin:.6rem 1px;">
    ...
    <a href="{{ url('http://staging.ictc.go.tz:2224/verify-user-account-' . $user->verificationKey) }}" target="_blank" style="background-color:#0884cb;color:#ffffff;font-size:medium; border-radius:.8rem; padding:.5rem .6rem; border: 1px #156694 solid; text-decoration:none">
        Verify Account Now
    </a>
