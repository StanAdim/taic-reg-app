        ...
        <div class="border-b-2 border-teal-500 flex justify-between items-center py-1">
          ...
          <div class=" my-2 mx-2 p-1 ">
            <button class="mx-1 h-8 w-auto bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-0.5 px-2 rounded" type="button">
              Edit Account <i class="fa-solid fa-right-to-bracket mx-2"></i>
            </button>
            <button class="mx-1 h-8 w-auto bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-0.5 px-2 rounded" type="button">
              Edit User Info <i class="fa-solid fa-right-to-bracket mx-2"></i>
            </button>
            <div class="bg-white rounded-lg shadow-md p-6 my-2 text-center">
              <div class="flex flex-wrap justify-evenly items-center">
                ...
                <div class="flex-grow bg-sky-50 px-8 py-2">
                  <h3 class="text-xl font-semibold text-sky-600 mb-2"> <span class=""></span>{{ userProfile?.firstName }}  <span class=""></span>{{ userProfile?.middleName }}  <span class=""></span>{{ userProfile?.lastName }}</h3>
