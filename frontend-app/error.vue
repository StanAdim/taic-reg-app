...
<template>
  <div class="flex flex-col justify-center items-center bg-sky-400/20 h-screen">
    <div class="text-center my-8  font-extrabold text-sky-600">
      <div class="text-2xl">Information And Communication Technologies Commission</div>
      <div class="text-lg">Events Management System</div>

    </div>
    <div class="">
      <p class="text-red-600">Something went wrong !!!</p>
      <p class="my-3 px-4 py-2 text-black/70 bg-white/60 rounded-md text-center ">{{props.error?.statusMessage}}</p>
      <button @click.prevent="handleError()">Go back Home</button>
    </div>
